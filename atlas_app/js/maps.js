  require([
      ...
      map.addLayer(flb);
      var chartC = new Cedar({ "specification": "/atlas_app/cedarspecs/customscatter.json" });
      var datasetC = {
      ...
      var chartR = new Cedar({ "specification": "/atlas_app/cedarspecs/customscatter.json" });
      var datasetR = {
          "url": "http://services5.arcgis.com/G79PVu14Duuuwxv3/arcgis/rest/services/crime2012/FeatureServer/0",
          "query": {
      ...
      var chartB = new Cedar({ "specification": "/atlas_app/cedarspecs/customscatter.json" });
      var datasetB = {
          "url": "http://services5.arcgis.com/G79PVu14Duuuwxv3/arcgis/rest/services/crime2012/FeatureServer/0",
          "query": {

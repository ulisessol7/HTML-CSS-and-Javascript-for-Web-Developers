  require([
      ...
      var assaults = "https://services5.arcgis.com/G79PVu14Duuuwxv3/arcgis/rest/services/crime2016/FeatureServer/0";
      ...
      var chartC = new Cedar({ "specification": "cedarspecs/customscatter2016.json" });
      var datasetC = {
          "url": "https://services5.arcgis.com/G79PVu14Duuuwxv3/arcgis/rest/services/crime2016/FeatureServer/0",
          "query": {
      ...
      var chartR = new Cedar({ "specification": "cedarspecs/customscatter2016.json" });
      var datasetR = {
          "url": "https://services5.arcgis.com/G79PVu14Duuuwxv3/arcgis/rest/services/crime2016/FeatureServer/0",
          "query": {
      ...
      var chartB = new Cedar({ "specification": "cedarspecs/customscatter2016.json" });
      var datasetB = {
          "url": "https://services5.arcgis.com/G79PVu14Duuuwxv3/arcgis/rest/services/crime2016/FeatureServer/0",
          "query": {
